...
This repository contains two versions of Telegram bots:

## 1. Genshin Impact Gift Code Bot [[GI-bot](https://github.com/ImThienz/telegram-bot-PC/tree/GI-bot)]

### Local Version (old-genshin_bot.py)
...
### PythonAnywhere Version (genshin_bot.py)
...
## 2. PC Control Bot (PC-bot.py)
- **Environment**: Runs locally as a Windows service
- **Features**:
  - Controls PC power states (shutdown, restart, sleep)
